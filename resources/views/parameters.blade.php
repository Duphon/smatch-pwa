            ...
            <div class="game-card shadow rounded">
                <form method="POST" action="{{ route('player.update') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="player_name" type="text" class="form-control @error('player_name') is-invalid @enderror"
                                name="player_name" value="{{ $player->name }}" required autocomplete="player_name"
                                autofocus>
