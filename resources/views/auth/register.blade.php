            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="player_name" class="col-md-4 col-form-label text-md-end">{{ __('Nom de joueur') }}</label>

                            <div class="col-md-6">
                                <input id="player_name" type="text" class="form-control @error('player_name') is-invalid @enderror" name="player_name" value="{{ old('player_name') }}" required autocomplete="player_name" autofocus>
