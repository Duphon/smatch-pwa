                        ...
                        <div class="columns">
                            ...
                            <div class="actions">
                                @php
                                    ...
                                    $elo_diff = $game->elo_value - $player->elo->value;
                                @endphp
                                @if ($elo_diff > 99)
                                    <div class="shadow"
                                        style="background-color:#bd0000;border-radius:60px;width:60px;height:60px;text-align:center;vertical-align:center;padding-top: 10px;">
                                ...
                                @elseif($elo_diff < -99)
                                    <div class="shadow"
                                        style="background-color:#d4c009;border-radius:60px;width:60px;height:60px;text-align:center;vertical-align:center;padding-top: 10px;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                                ...
                                @else
                                    <div class="shadow"
                                        style="background-color:#09991c;border-radius:60px;width:60px;height:60px;text-align:center;vertical-align:center;padding-top: 10px;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
